...
\While{Mientras haya un hombre $m$ que esté libre y no se haya declarado a todas las mujeres $w$ por las que $(m, w) \not\in F$}
...
a la que $m$ aún no ha propuesto matrimonio
    ...
    \Else \Comment{$w$ está comprometida con $m'$}
        \If{$w$ prefiere a $m'$ antes que $m$}
            \State $m$ permanece libre.
        \Else \Comment{$w$ prefiere a $m$ antes que $m'$}
            \State $(m, w)$ se comprometen.
            \State $m'$ queda libre
        \EndIf
    \EndIf
